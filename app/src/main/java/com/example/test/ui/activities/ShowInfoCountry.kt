...
class ShowInfoCountry : AppCompatActivity() {
    ...
    private fun checkItemSaved() {
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            if (check) {
                binding.btnSave.setImageDrawable(resources.getDrawable(R.drawable.ic_favorite_24))
            }
        ...
        lifecycleScope.launch(Dispatchers.Main) {
           check = withContext(Dispatchers.IO) {
            ...
            if (check) {
                ...
                binding.btnSave.setImageDrawable(resources.getDrawable(R.drawable.ic_favorite_border_24))
